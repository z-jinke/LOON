        ...
        if (url.includes("/ipad")) {
            ...
            if (obj.data) {
                ...
                obj.data.sections_v2 = [
                    ...
                    {"items":[
                        {"id":407,"title":"客服","icon":"http://i0.hdslb.com/bfs/feed-admin/7801a6180fb67cf5f8ee05a66a4668e49fb38788.png","common_op_item":{},"uri":"bilibili://user_center/feedback"},
                        {"id":410,"title":"设置","icon":"https://i0.hdslb.com/bfs/feed-admin/34e8faea00b3dd78977266b58d77398b0ac9410b.png","common_op_item":{},"uri":"bilibili://user_center/setting"}
                    ],"style":2,"button":{}}
                ];
            }
        }
